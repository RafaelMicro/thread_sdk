...
void my_fault_handler_c(uint32_t *sp, uint32_t lr_value)
{
    ...
    _exp_log_out("CFSR= %x, UsageFault= %x, BusFault= %x, MemManage= %x\r\n",
      *((uint32_t*)(0xE000ED28)), *((uint16_t*)(0xE000ED2A)), *((uint8_t*)(0xE000ED29)), *((uint8_t*)(0xE000ED28)));

    _exp_log_out("0xA0300020=%x 0xA0300024=%x \r\n",
        *((uint32_t*)(0xA0300020)),*((uint32_t*)(0xA0300024)));
    
    _exp_log_out("FLASH->CONTROL_SET %x \r\n",FLASH->CONTROL_SET );
    while (1)
        ;
