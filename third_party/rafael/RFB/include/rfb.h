...
typedef struct rfb_zb_ctrl_s
{
    ...
    *                      3: add/set address entry - link matrics LQI (ehn-ack),
    *                      4: clear address entry   - link matrics LQI (ehn-ack),
    *                      5: add/set address entry - link matrics link margin (ehn-ack),
    *                      6: clear address entry   - link matrics link margin (ehn-ack),
    *                      7: add/set address entry - link matrics RSSI (ehn-ack),
    *                      8: clear address entry   - link matrics RSSI (ehn-ack),
...
typedef struct rfb_subg_ctrl_s
{
    ...
    * @image
    */
    void (*init)(rfb_interrupt_event_t *_rfb_interrupt_event, rfb_keying_type_t keying_mode);
